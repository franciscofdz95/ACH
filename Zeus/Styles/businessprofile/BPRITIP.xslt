...
<xsl:stylesheet
  ...
  *********************************************
  ...
  <xsl:include href="../itip/IndustryTradeProfile.xslt" />
        ...
        <table width="715" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr>
            <td>      
              ...
              <xsl:if test="//prd:BusinessProfile/prd:IndustryTradeGroup"> 
                <!-- Back to Top graphic -->
                <xsl:call-template name="BackToTop" />
                <br/>
              </xsl:if>

              <!-- ITIP within BusinessProfile template -->
              <xsl:apply-templates select="//prd:BusinessProfile" mode="ITIP" />
  ...
  *********************************************
  ...
  <xsl:template match="prd:BusinessProfile" mode="header" xml:space="preserve">
    ...
    <xsl:variable name="profileType">
      <xsl:value-of select="'BPR and Industry Trade Profile'" />
    </xsl:variable>
