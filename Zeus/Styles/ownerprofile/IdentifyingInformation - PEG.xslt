              ...
              <td bgcolor="#ffffff">
                  ...
                  <tr>
                    ...
                    <td width="38%" valign="top">
                      <font size="1" style="FONT-FAMILY: 'verdana';">
                        <b><xsl:text disable-output-escaping="yes" width="4px"></xsl:text><xsl:value-of select="prd:ConsumerIdentity/prd:Name/prd:Gen" /></b>
                        <br />
				...
				<xsl:choose>
				  ...
				  <xsl:otherwise>
		                    <tr>
		                      <td>
		                        <img src="../resources/spacer.gif" width="1" height="1" border="0" alt="" /></td>
		                    </tr>
				  </xsl:otherwise>
				</xsl:choose>
<!--
...
-->
                  ...
                  <tr>
                    <td colspan="3">
                      <img src="../resources/spacer.gif" border="0" width="1" height="1" alt="" /></td>
                  </tr>
                </table>
                ...
                <xsl:if test="starts-with($inquiry, 'NARQ') ">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td colspan="3">
                        <img src="../resources/spacer.gif" border="0" width="1" height="5" alt="" /></td>
                    </tr>

                    <tr>
                      <td colspan="3" valign="top"><font color="{$borderColor}" size="1" style="FONT-FAMILY: 'verdana';">
                       <xsl:text disable-output-escaping="yes" width="4px"></xsl:text><b>*</b></font><font size="1" style="FONT-FAMILY: 'verdana';"><b><xsl:value-of select="$narqName" /></b>

                       <xsl:if test="normalize-space($narqAddr1)">
                            <br />
                            <xsl:text disable-output-escaping="yes" width="12px"></xsl:text><xsl:value-of select="$narqAddr1" />
                       </xsl:if>

                       <xsl:if test="normalize-space($narqAddr2)">
                            <br />
                            <xsl:text disable-output-escaping="yes" width="12px"></xsl:text><xsl:value-of select="$narqAddr2" />
                       </xsl:if>
                    ...
                    <tr>
                      <td colspan="3">
                        <img src="../resources/spacer.gif" border="0" width="1" height="10" alt="" /></td>
                    </tr>

                    <tr>
                      <td colspan="3"><font color="{$borderColor}" size="1" style="FONT-FAMILY: 'verdana';">
                        <xsl:text disable-output-escaping="yes" width="4px"></xsl:text><b>*</b>Business name and address reflect the inquiry information and have not been verified by Experian.</font></td>
                    </tr>
                ...
                <xsl:if test="false()"> <!--  starts-with($inquiry, 'INQF') " -->
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td colspan="3" valign="top"><font color="{$borderColor}" size="1" style="FONT-FAMILY: 'verdana';">
                        <xsl:text disable-output-escaping="yes" width="4px"></xsl:text><b>*</b>
<!--
                        <xsl:text disable-output-escaping="yes" width="4px"></xsl:text><b>*Business ID Number: <xsl:value-of select="$inqfBin" /></b>
-->
                        </font>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="3"><font color="{$borderColor}" size="1" style="FONT-FAMILY: 'verdana';">
                        <xsl:text disable-output-escaping="yes" width="4px"></xsl:text><b>*</b>Business name and address reflect the inquiry information and have not been verified by Experian.</font></td>
<!--
                        <xsl:text disable-output-escaping="yes" width="4px"></xsl:text><b>*</b>Business ID Number reflects the inquiry information and has not been verified by Experian.</font></td>
-->
                    </tr>
...
-->
    ...
    <xsl:if test="string-length(normalize-space(prd:StreetSuffix)) &gt; 2">
      <xsl:text disable-output-escaping="yes" width="4px"></xsl:text><xsl:value-of select="normalize-space(prd:StreetSuffix)" /> 
      <br />
    </xsl:if>
    <xsl:text disable-output-escaping="yes" width="4px"></xsl:text><xsl:value-of select="normalize-space($formattedZip)" /> 
    <br />
    ...
    <tr>
      <xsl:choose>
	   ...
	   <td align="right" nowrap="nowrap"><font size="1" style="FONT-FAMILY: 'verdana';">
	     <b>Employer:<xsl:text disable-output-escaping="yes" width="8px"></xsl:text></b></font></td>
	 </xsl:when>

	 <xsl:otherwise>
	   <td>
	     <img src="../resources/spacer.gif" border="0" width="16" height="1" alt="" /></td>
	 </xsl:otherwise>
      </xsl:choose>    
      ...
      <tr>
        ...
        <td align="left" nowrap="nowrap"><font size="1" style="FONT-FAMILY: 'verdana';">
          <xsl:value-of select="prd:AddressFirstLine" />
            <xsl:if test="not (prd:AddressSecondLine) and not (AddressExtraLine) and prd:Zip and normalize-space(prd:Zip) != '' "><xsl:text disable-output-escaping="yes" width="4px"></xsl:text><xsl:value-of select="prd:Zip" /></xsl:if>
        </font></td>
      </tr>
    </xsl:if>
      ...
      <tr>
        ...
        <td align="left" nowrap="nowrap"><font size="1" style="FONT-FAMILY: 'verdana';">
          <xsl:value-of select="prd:AddressSecondLine" />
            <xsl:if test="not (AddressExtraLine) and prd:Zip and normalize-space(prd:Zip) != '' "><xsl:text disable-output-escaping="yes" width="4px"></xsl:text><xsl:value-of select="prd:Zip" /></xsl:if>
          </font></td>
      </tr>
    </xsl:if>
      ...
      <tr>
        ...
        <td align="left" nowrap="nowrap"><font size="1" style="FONT-FAMILY: 'verdana';">
          <xsl:value-of select="prd:AddressExtraLine" />
            <xsl:if test="prd:Zip and normalize-space(prd:Zip) != '' "><xsl:text disable-output-escaping="yes" width="4px"></xsl:text><xsl:value-of select="prd:Zip" /></xsl:if>
          </font></td>
      </tr>
    </xsl:if>
    ...
    <xsl:if test="$lastDate and normalize-space($lastDate) != '' ">
      <tr>
        <td>
          <img src="../resources/spacer.gif" border="0" width="16" height="1" alt="" /></td>
        <td align="left" nowrap="nowrap"><font size="1" style="FONT-FAMILY: 'verdana';">
          <b>Last Updated:<xsl:text disable-output-escaping="yes" width="8px"></xsl:text></b><xsl:value-of select="$lastDate" />
          </font></td>
      </tr>
    </xsl:if>
