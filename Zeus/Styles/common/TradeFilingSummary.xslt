...
<xsl:stylesheet version="1.0" 
  ...
  *********************************************
  -->
  <xsl:template name="TradeFilingSummary">

    <xsl:call-template name="FilingSummary" />
    <br />
    <xsl:call-template name="TradeSummary" />
  ...
  *********************************************
  -->
  <xsl:template name="FilingSummary">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" height="20">
          <font color="{$borderColor}"><b><xsl:if test="$product = 'SBI' or $product = 'SBIBOP' ">Business </xsl:if>Legal Filings and Collections</b></font>
        </td>
      </tr>  
              ...
              <td height="20">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="95%">
			   <xsl:choose>
			      <xsl:when test="$product = 'CI' or $product = 'SBI' or $product = 'SBIBOP' or (($product = 'CIBPR' or $product = 'BPR') and $scorable = 'false')">
			         Tax lien filings:
			      </xsl:when>
  ...
  *********************************************
  -->
  <xsl:template name="TradeSummary">
    <xsl:variable name="limitedReport">
      <xsl:choose>		              
        <xsl:when test="prd:ExecutiveElements">		    		   		   
          <xsl:value-of select="0" />
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" height="20">
          <font color="{$borderColor}"><b><xsl:if test="$product = 'SBI' or $product = 'SBIBOP' ">Business </xsl:if>Trade Information</b></font>
        </td>
      </tr>  
      ...
      <tr>
        <td width="100%" valign="top">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <xsl:if test="$product = 'SBI' or $product = 'SBIBOP' ">
	            <tr>
	              <td height="20">
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                  <tr>
            ...
            <xsl:if test="$product != 'SBI' and $product != 'SBIBOP' ">
	            <tr>
	              <td height="20">
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                  <tr>
	            ...
	            <tr>
	              <td height="20">
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                  <tr>
	                    <td width="95%">
	                      Total trade balance <xsl:value-of select="$totalTrade" />:</td>
	                    <td width="5%" align="right" nowrap="nowrap"><b><xsl:value-of select="$totalTradeBalance" /></b></td>
	                  </tr>
	                </table>
	              </td>  
            ...
            <tr>
              <td height="20">
			   ...
			   <xsl:choose>
			      ...
			      <xsl:when test="$product = 'SBI' or $product = 'SBIBOP' ">
			         Recent high credit:
			      </xsl:when>
