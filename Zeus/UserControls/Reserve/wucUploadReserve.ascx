<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucUploadReserve.ascx.cs" Inherits="ZeusWeb.UserControls.Reserve.wucUploadReserve" %>
<%@ Register Src="wucUploadGrid.ascx" TagName="wucUploadGrid" TagPrefix="uc1" %>
<fieldset>
     <legend>Upload Reserve</legend>
