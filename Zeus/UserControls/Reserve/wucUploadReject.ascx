<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucUploadReject.ascx.cs" Inherits="ZeusWeb.UserControls.Reserve.wucUploadReject" %>
<%@ Register Src="wucUploadGrid.ascx" TagName="wucUploadGrid" TagPrefix="uc1" %>
<fieldset>
    <legend>Upload Reject</legend>
