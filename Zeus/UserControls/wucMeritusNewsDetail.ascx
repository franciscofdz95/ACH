<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="UserControls_wucMeritusNewsDetail" Codebehind="wucMeritusNewsDetail.ascx.cs" %>
                        ...
                        <td valign="top">
                            <div class="editblock">
                                <div class="left">
                                    NewsID:</div>
                                <div class="right">
                                    <asp:Label runat="server" ID="NewsID"></asp:Label></div>
                            </div>
                            <div class="editblock">
                                <div class="left">
                                    News Date:</div>
                                <div class="right">
                                    <ig:WebDatePicker ID="NewsDate" runat="server" EnableAppStyling="False" NullDateLabel="">
        ...
        <div style="padding: 10px;">
            <div class="editblock">
                <div class="left">
                    Template:</div>
                <div class="right">
                    <asp:DropDownList runat="server" AutoPostBack="true" ID="ddlTemplate" OnSelectedIndexChanged="ddlTemplate_SelectedIndexChanged">
                        <asp:ListItem Value="0">No Template</asp:ListItem>
                        <asp:ListItem Value="1">Paysafe Standard</asp:ListItem>
                    </asp:DropDownList>
                </div>
            </div>
            <span class="required">*</span>Content:
            <ighedit:WebHtmlEditor ID="HTMLContent" runat="server" Width="800px" FontFormattingList="Heading 1=<h1>&Heading 2=<h2>&Heading 3=<h3>&Heading 4=<h4>&Heading 5=<h5>&Normal=<p>"
