<%@ Page Language="C#" MasterPageFile="~/MasterPageRisk.master" AutoEventWireup="true" Inherits="frmCVV2Summary"
    Title="CVV2 Summary" Codebehind="~/SecureRiskForms/frmCVV2Summary.aspx.cs" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<%@ Register Assembly="Infragistics45.WebUI.WebDataInput.v19.2, Version=19.2.20192.8, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" Namespace="Infragistics.WebUI.WebDataInput" TagPrefix="igtxt" %>
<%@ Register Assembly="Infragistics45.Web.v19.2, Version=19.2.20192.8, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" Namespace="Infragistics.Web.UI.EditorControls" TagPrefix="ig" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <fieldset>
        <legend>CVV2 Summary Report</legend>
    ...
    <fieldset>
        ...
        <rsweb:ReportViewer ID="CVV2Summary1" runat="server" Width="100%" Height="500px" Font-Size="8pt"
            Style="padding: 5px 0px 30px 0px;" Font-Names="Verdana">
            <LocalReport ReportPath="Reports\CVV2Summary.rdlc">
                <DataSources>
