<%@ Page Language="C#" MasterPageFile="~/MasterPageRisk.master" AutoEventWireup="true"
    Inherits="frmRiskSuspended" Title="Suspended Batch Summary" CodeBehind="frmRiskSuspended.aspx.cs" %>
            ...
            if (null != gridViewCtlId) {
                ...
                for (; i < (gridViewCtlId.rows.length - 1); i = i + 2) {
                    ...
                    if (txt == '1') {
                        ...
                        CollapseExpand(gridViewCtlId.rows[i].cells[17].innerHTML, 'inline', gridViewCtlId.id + '_img1_' + j);
                        j++;
                    }
                    else {
                        
                        CollapseExpand(gridViewCtlId.rows[i].cells[17].innerHTML, 'none', gridViewCtlId.id + '_img1_' + j);
                        j++;
                    }
                }
            ...
            <asp:GridView ID="grdRisk" runat="server" OnRowCommand="grdRisk_RowCommand" ShowFooter="true"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Release">
                        <ItemTemplate>
                            <asp:Button ID="btnRelease" runat="server" Text="Release" CommandName="Release" Font-Size="X-Small"
                                OnClientClick="return confirm('Do you want to RELEASE this batch?');" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="SuspendedDate" HeaderText="Date Suspended" SortExpression="SuspendedDate" />
