<%@ Page Title="Lead Documents" Language="C#" MasterPageFile="~/MasterPageSales.master" AutoEventWireup="true" Inherits="frmLeadDocuments" Codebehind="frmLeadDocuments.aspx.cs" %>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:HiddenField runat="server" ID="LeadID" />
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                ...
                <table width="100%">
                    <tr>
                        <td>
                            ...
                            <asp:ObjectDataSource ID="ods" TypeName="DataMerchantAppPaging" runat="server" SelectMethod="GetDocumentPaging"
                                SelectCountMethod="GetDocumentPagingCount" OnSelecting="ods_Selecting" EnablePaging="True"
