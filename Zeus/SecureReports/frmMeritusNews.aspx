<%@ Page Language="C#" MasterPageFile="~/MasterPageReports.master" AutoEventWireup="true" Inherits="SecureReports_frmMeritusNews" Title="Paysafe News" Codebehind="frmMeritusNews.aspx.cs" %>

<%@ Register Src="../UserControls/wucMessage.ascx" TagName="wucMessage" TagPrefix="uc2" %>
<%@ Register Src="../UserControls/wucMeritusNewsDetail.ascx" TagName="wucMeritusNewsDetail"
    TagPrefix="uc1" %>
    ...
    <div id="contentpage" style="padding: 5px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:HyperLink runat="server" Visible="false" Style="line-height: 32px; height: 32px;"
                                NavigateUrl="~/SecureReports/frmMeritusNews.aspx" ID="hypBack">Back To Search</asp:HyperLink></td>
                    </tr>
                </table>
            </div>
        </asp:Panel>
        ...
        <asp:Panel runat="server" ID="pnlEdit">
            <fieldset>
                ...
                <uc1:wucMeritusNewsDetail ID="WucMeritusNewsDetail1" runat="server" />
            </fieldset>
        </asp:Panel>
        <asp:Panel runat="server" ID="pnlSearch">
            <fieldset>
                <legend>Search Paysafe News</legend>
                <div class="MAGrid">
                    <div class="myblock">
                        <div class="mylabel">
                            Portal:</div>
                    ...
                    <div class="myblock">
                        <div class="mylabel">
                            NewsID:</div>
                        <div class="myinput">
                            <asp:TextBox runat="server" ID="NewsID"></asp:TextBox></div>
                    </div>
                    <div class="myblock">
                        <div class="mylabel">
                            Subject:</div>
            ...
            <fieldset>
                ...
                <asp:Panel runat="server" ID="pnlRecords">
                    ...
                    <asp:GridView runat="server" ID="gvMeritusNews" OnRowCommand="gvMeritusNews_RowCommand"
                        PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" OnSorting="gvMeritusNews_Sorting"
                        CssClass="mGrid" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True"
                        OnPageIndexChanging="GridView1_PageIndexChanging" DataSourceID="odsMertiusNews"
                        OnRowDataBound="gvMeritusNews_RowDataBound">
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField runat="server" ID="hidNewsUID" Value='<%# Bind("UID") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="NewsID" SortExpression="NewsID">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="News Date" SortExpression="NewsDate">
                                <ItemTemplate>
                                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("NewsDate", "{0:MM/dd/yyyy}") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:ObjectDataSource runat="server" ID="odsMertiusNews" EnablePaging="true" MaximumRowsParameterName="PageSize"
                        StartRowIndexParameterName="CurrentPage" OnSelecting="odsMertiusNews_Selecting"
                        SelectCountMethod="SelectMeritusNews_PagingCount" SelectMethod="SelectMeritusNews_Paging"
