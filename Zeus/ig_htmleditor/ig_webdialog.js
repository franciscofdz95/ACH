...
function igdlg_showDialog(contextDlg, height, width)  // context is the WebDialog control making the OBC
{
    ...
    {
        // V.S. 2/2/2018 Bug #247097: Extend timeout for Edge in order to properly show dialog windows
        var callbackTimeOut = ig_shared.IsEdge ? 100 : 0; 
        window.setTimeout(ig_createCallback(contextDlg._openWindow, contextDlg), callbackTimeOut);
	}
