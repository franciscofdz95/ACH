...
namespace AchSystem
{
    public abstract class NachaFile
    {
        ...
        public ILogging NachFileLog = new Log();
        ...
        public int FileBatchNumber
        {
            get { return m_FileBatchNumber; }
            set { m_FileBatchNumber = value; }
        }
        ...
        public void AddBatch(NachaBatch batch)
        {
            this.BatchCount += 1;
            this.TotalLines += 2;
            this.FileBatchNumber += 1;

            batch.BatchNumber = this.FileBatchNumber;
            this.Batches.Add(batch);
        }

        public abstract NachaBatch CreateBatch();

        public abstract NachaBatch CreateBatch(ILogging log);
