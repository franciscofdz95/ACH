...
namespace AchSystem
{
    ...
    /// </summary>
    public class BankChase : Bank
    {
        public BankChase() { }

        public BankChase(string bank, int bankid)
            : base(bank, bankid)
        {
            ...
            this.SettlementFileName = this.SettleFileDirectory + bank +  @"\MERITUS.ACH.NACHA." + DateTime.Today.ToString("yyyyMMdd") + ".ACH";
