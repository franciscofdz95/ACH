...
{
    public class DataMerchantType : iData
    {
        public SqlDataReader Select(ArrayList prms)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Search_Merchant_Type";
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Delete_MerchantType";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Update_MerchantType";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Insert_MerchantType";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
            ...
            if (intRows > 0)
                return Convert.ToInt64(cmd.Parameters["@MerchantTypeID"].Value);
            else
                return -1;
        }
    }
