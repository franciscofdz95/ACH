...
{
    public class DataRefcode : iData
    {
        public SqlDataReader Select(ArrayList prms)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Search_Refcode";
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Delete_Refcode";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Update_Refcode";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Insert_Refcode";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
            ...
            if (intRows > 0)
                return Convert.ToInt64(cmd.Parameters["@RefcodeID"].Value);
            else
                return -1;
        }
    }
