...
{
    public class DataOrigin : iData
    {
        public SqlDataReader Select(ArrayList prms)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Search_Origin";
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Delete_Origin";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Update_Origin";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Insert_Origin";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
            ...
            if (intRows > 0)
                return Convert.ToInt64(cmd.Parameters["@OriginID"].Value);
            else
                return -1;
        }
    }
