...
{
    public class DataGroupMerchant : iData
    {
        public SqlDataReader Select(ArrayList prms)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Search_Group_Merchant";
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Delete_Group_Merchant";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Update_Group_Merchant";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
        ...
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Ach_Insert_Group_Merchant";
            cmd.CommandType = CommandType.StoredProcedure;
            DataLayer.AppendParamters(cmd, prms);
            ...
            if (intRows > 0)
                return Convert.ToInt64(cmd.Parameters["@GroupID"].Value);
            else
                return -1;
        }
    }
